...
* [Цепочка обязанностей](../ChainOfResponsibility/ChainOfResponsibility.md), [Команда](../Command/Command.md), [Посредник](../Mediator/Mediator.md) и Наблюдатель показывают различные способы работы отправителей запросов с их получателями:
...
* Можно воспользоваться паттерном [Одиночка](../Singleton/Singleton.md), чтобы гарантировать уникальность и глобальную доступность наблюдаемого объекта.
